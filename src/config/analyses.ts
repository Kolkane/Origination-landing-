...
export const analyses: Article[] = typoDeep([
  {
    ...
    corps: [
      ...
      "Le marché visible des entreprises à vendre est donc, structurellement, un marché en retard : il ne montre que les dirigeants déjà engagés dans un processus. La valeur, pour qui sait la détecter, est en amont, chez ceux qui n’ont encore rien annoncé mais dont la situation réunit déjà les conditions.",
  ...
  },
  {
    ...
    corps: [
      ...
      "Du côté du cédant, cette absence de processus a un coût rarement mesuré. Une entreprise vendue sans mise en concurrence se cède souvent en dessous de sa valeur, faute d’un second acquéreur pour faire jouer les enchères. Le dirigeant qui a passé sa vie à construire son affaire en laisse une part sur la table, non par mauvaise négociation, mais parce qu’il n’a jamais su qu’une négociation était possible.",
  ...
  },
  {
    ...
    corps: [
      ...
      "À cela s’ajoute un problème de structure. Ce travail échoit généralement aux profils juniors, pour qui il n’offre aucune trajectoire : on ne fait pas carrière en sourçant. Les meilleurs partent vite, et emportent avec eux la méthode qu’ils avaient fini par construire. Le cabinet recommence à zéro.",
      ...
      "L’alternative interne coûte plus cher qu’on ne le croit. Un analyste dédié à ce seul travail représente un salaire chargé conséquent, du temps avant d’être utile, et un départ probable à moyen terme. Le tout pour un résultat non exclusif, que rien n’empêche un cabinet concurrent d’obtenir en parallèle.",
